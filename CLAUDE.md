...
> **Shared conventions** (git workflow, merge strategy, code quality, confirm behavior, security, commit attribution): See the shared conventions section at the end of this file
